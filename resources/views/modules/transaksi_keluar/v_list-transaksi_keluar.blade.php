@extends('layouts.app',['title' => 'Transaksi Keluar'])
@section('content')
<div class="row">
    <div class="col-12">
...
<div class="modal fade" tabindex="-1" role="dialog" id="exampleModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="" method="POST" id="form-outgoing" accept-charset="utf-8">
...
@endsection
@push('script')
<script type="module" src="{{ asset('js/app/outgoing.js') }}" charset="utf-8"></script>
@endpush
